...
public class OutputPanel extends JPanel {
    ...
    private void initialize() {
        ...
        locationLabel.setText("The data will be stored to a lucene index.");
        ...
        fileLabel.setText("Output folder for lucene:");
    ...
    public JTextField getFileField() {
        if (fileField == null) {
            ...
            fileField.setText(new File("lucenepath").getAbsolutePath());
        }
        return fileField;
    }
