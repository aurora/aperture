...
public class ZipSubCrawlerTestCombination extends ApertureTestBase {
    ...
    public void setUp() throws IOException {
        ...
        IOUtil.writeStream(ResourceUtil.getInputStream(DOCS_PATH + "zip-test.zip"), tmpFile3);
    ...
    public void testCrawler() throws ModelException, InterruptedException {
        ...
        subCrawlerRegistry.add(new ZipSubCrawlerFactory());
        ...
        // inspect results (we have 6 files + 9 entries in the zip archive)
        assertNewModUnmodDel(crawlerHandler, 15, 0, 0, 0);
        assertTrue(accessData.getStoredIDs().size() == 15);
        ...
        assertNewModUnmodDel(crawlerHandler, 0, 0, 15, 0);
        assertTrue(accessData.getStoredIDs().size() == 15);
        ...
        assertNewModUnmodDel(crawlerHandler, 0, 1, 4, 10);
