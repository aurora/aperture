...
public class FileExtractorTestBase extends ApertureTestBase {

    public RDFContainer extract(String resourceName, FileExtractor extractor) throws FileExtractorException,
            IOException {
        // setup some info
        ...
        File tempFile = File.createTempFile("testfileextractor", "tmp");
        ...
        // apply the extractor
        extractor.extract(id, tempFile, null, null, rdfContainer);
        stream.close();
        tempFile.delete();
