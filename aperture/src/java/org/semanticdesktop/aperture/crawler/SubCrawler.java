...
/**
 * A SubCrawler accesses a FileDataObject and produces a stream of other DataObjects representing the
 ...
 * crawling, i.e. to scan and report the differences in the FileDataObject since the last crawl.
 */
