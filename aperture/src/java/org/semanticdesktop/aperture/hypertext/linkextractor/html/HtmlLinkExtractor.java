...
public class HtmlLinkExtractor implements LinkExtractor, TokenHandler {
    ...
    // the link extraction should disregard links that occur inside scripts, problems have been
    // reported with links generated by concatenation e.g.
    //
    //  var innerHTML = 
    //    '<a href="' + 
    //    url + 
    ...
    //    '<\/a>';
    //
    // this flat turns to true inside script tags, which discards any other tag-like
    // structures that occur inside
    ...
    public void endOfStartTag() {
        ...
        if (insideScriptTag) {
            // ignore every tag-like construct that occurs inside the <SCRIPT> tag
            return;
        }
        ...
        else if ("SCRIPT".equals(startTag)) {
