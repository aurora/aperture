...
/**
 * Vocabulary File. Created by org.semanticdesktop.aperture.util.VocabularyWriter on Thu Aug 09 17:41:38 CEST 2007
 * input file: D:\workspace\aperture-nie/doc/ontology/fresnel.owl
 * namespace: http://www.w3.org/2004/09/fresnel#
 */
public class FRESNEL {

    public static final String FRESNEL_RESOURCE_PATH = 
      FRESNEL.class.getPackage().getName().replace('.', '/') + "/fresnel.owl";
     ...
     * Domain: node12h5kjga4x120  <br/>
     * Range: node12h5kjga4x123  <br/>
     */
