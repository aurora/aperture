 ...
 * 
 * <p>
 * The main purpose of this class is to be able to conveniently access the set of DataSourceDetectors in
 ...
 */
public class DefaultDataSourceDetectorRegistry extends DataSourceDetectorRegistryImpl {
    ...
    private class DataSourceDetectorParser extends SimpleSAXAdapter {
        ...
        private void processClassName(String className) {
            ...
            if (!className.equals("")) {
                try {
                    ...
                    logger.warn("unable to cast instance to " + DataSourceDetector.class.getName()
                            + ", ignoring", e);
                }
            }
        }
