...
public class MagicMimeTypeIdentifierFactory implements MimeTypeIdentifierFactory {
    ...
    // interpretation) and are stateless after initialization, so they can be shared by whoever needs a
    // MimeTypeIdentifier. On the other hand, you don't want to keep the MIME type descriptions with
    // information about magic numbers, file extensions etc. in main memory indefinitely.
    
    // A SoftReference could have been used as well, which is kept in main memory for a longer period.
