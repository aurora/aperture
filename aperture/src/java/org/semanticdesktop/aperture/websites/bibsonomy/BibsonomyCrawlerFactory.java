 ...
 * @author grimnes
 */
public class BibsonomyCrawlerFactory implements CrawlerFactory {
    ...
    public Set getSupportedTypes() {
		return Collections.singleton(BIBSONOMYDS.BibsonomyDataSource);
	}
	...
	public Crawler getCrawler(DataSource dataSource) {
			return new BibsonomyCrawler(dataSource);
	}
}
