...
public class ExampleImapCrawler extends AbstractExampleCrawler {
    ...
    protected String getSpecificExplanationPart() {
        ...
        builder.append(getAlignedOption(TEST_URIS_OPTION) + "check if the uris generated by the crawler are compliant\n " +
                       getAlignedOption("") + "with RFC 2192. this setting overrides " + AbstractExampleCrawler.VALIDATE_OPTION + " and\n " + 
                       getAlignedOption("") + AbstractExampleCrawler.PERFORMANCE_OPTION + "\n");
        builder.append(getAlignedOption(IGNORE_UID_VALIDITY_OPTION) + "crawler ignores the UIDVALIDITY value from the server\n" +
                       getAlignedOption("") + "and assumes that UIDs are valid. USE AT YOUR OWN RISK");
