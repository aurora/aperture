...
1. Downloaded the Sesame 2.1.1 onejar release from sourceforge:
http://sourceforge.net/project/showfiles.php?group_id=46509&package_id=168413&release_id=599197
The openrdf-sesame-2.1.1-onejar.jar got copied into this folder
...
java -jar bnd-0.0.249.jar wrap 
     -output openrdf-sesame-2.1.1-onejar-osgi.jar 
     -properties openrdf-sesame-2.1.1-onejar.bnd 
     openrdf-sesame-2.1.1-onejar.jar
     
(Obviously the entire command needs to go in the same line, the linebreaks have been
included for readability).

5. Copied the resulted openrdf-sesame-2.1.1-onejar-osgi.jar into the lib folder.