...
public class YearMonthDurationCheckerTest {
    ...
    @Test public void test1() {
        ...
        assertTrue(checker.checkString("-P1347M"));
        assertFalse(checker.checkString("P1DT15H"));
        assertFalse(checker.checkString("PT15H30M23S"));
    }
}
